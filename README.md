...
CORS/n=one/r=a/o=y-10                526.8n ± 1%   548.4n ± 0%   +4.10% (p=0.000 n=10)
CORS/n=one/r=a/o=n-10                528.9n ± 1%   538.9n ± 1%   +1.90% (p=0.001 n=10)
CORS/n=multiple/r=a/o=y-10           541.9n ± 1%   555.5n ± 1%   +2.52% (p=0.000 n=10)
CORS/n=multiple/r=a/o=n-10           539.4n ± 0%   531.9n ± 0%   -1.39% (p=0.000 n=10)
CORS/n=two/r=a/o=y-10                582.8n ± 0%   558.0n ± 0%   -4.25% (p=0.000 n=10)
CORS/n=two/r=a/o=n-10                579.9n ± 0%   529.7n ± 0%   -8.66% (p=0.000 n=10)
CORS/n=many/r=a/o=y-10              1038.0n ± 2%   571.1n ± 2%  -44.98% (p=0.000 n=10)
CORS/n=many/r=a/o=n-10               637.6n ± 0%   527.6n ± 0%  -17.25% (p=0.000 n=10)
CORS/n=all/r=a/o=y-10                527.9n ± 1%   523.8n ± 0%   -0.78% (p=0.002 n=10)
CORS/n=one/r=p/o=y-10                451.4n ± 0%   434.7n ± 0%   -3.70% (p=0.000 n=10)
CORS/n=one/r=p/o=n-10                383.0n ± 2%   106.3n ± 1%  -72.26% (p=0.000 n=10)
CORS/n=multiple/r=p/o=y-10           453.9n ± 0%   435.1n ± 0%   -4.14% (p=0.000 n=10)
CORS/n=multiple/r=p/o=n-10           389.4n ± 0%   112.9n ± 0%  -71.01% (p=0.000 n=10)
CORS/n=two/r=p/o=y-10                501.9n ± 0%   439.6n ± 0%  -12.40% (p=0.000 n=10)
CORS/n=two/r=p/o=n-10                436.4n ± 0%   110.9n ± 0%  -74.58% (p=0.000 n=10)
CORS/n=many/r=p/o=y-10               929.1n ± 1%   457.0n ± 0%  -50.81% (p=0.000 n=10)
CORS/n=many/r=p/o=n-10               490.6n ± 0%   107.3n ± 1%  -78.12% (p=0.000 n=10)
CORS/n=all/r=p/o=y-10                445.3n ± 0%   424.4n ± 0%   -4.69% (p=0.000 n=10)
CORS/n=all/r=p/o=y/m=evil_acrh-10    448.9n ± 0%   124.9n ± 0%  -72.18% (p=0.000 n=10)
